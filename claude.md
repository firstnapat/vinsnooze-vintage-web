...
-   **Detailed analysis documents enable efficient content personalization** - Having comprehensive background information allows for precise representation of technical skills and career progression
-   **Single-file portfolio architecture simplifies content updates dramatically** - The decision to use a single HTML file makes personalization straightforward and low-risk
-   **Thai language localization requires attention to technical terminology** - Ensuring accurate translation of technical terms like "MLOps" and "Computer Vision" is crucial for professional credibility

### Project-Specific Patterns
-   **Portfolio Development**: Single-file HTML architecture enables rapid deployment and easy content updates
-   **Content Personalization**: Detailed analysis documents enable efficient transformation from generic to personalized content
-   **Thai Technical Localization**: Professional Thai language portfolios require careful attention to technical terminology translation
...
-   **Direct-to-main workflow preference** - For greenfield/portfolio projects, prefers working directly on main branch instead of feature branches
